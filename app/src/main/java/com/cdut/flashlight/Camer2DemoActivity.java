...
public class Camer2DemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camer2_demo);
    ...
    public static void start(Context context){
        Intent intent = new Intent(context,Camer2DemoActivity.class);

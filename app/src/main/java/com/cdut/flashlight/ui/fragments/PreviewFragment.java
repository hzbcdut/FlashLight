package com.cdut.flashlight.ui.fragments;
...
import com.cdut.flashlight.ui.ChangeCameraActivity;
import com.cdut.flashlight.ui.ImageSaver;
import com.cdut.flashlight.ui.view.AutoFitTextureView;
import com.cdut.flashlight.ui.view.DngImageSaver;
import com.cdut.flashlight.utils.CompareSizesByArea;
...
//        mPreviewView.setAlpha(0.0f);
    ...
    private void takePicture() throws CameraAccessException {
        ...
        Log.i("format", SpUtil.getCameraFormat(getActivity()));
        if (SpUtil.getCameraFormat(getActivity()).equals("JPEG")) {
            mSession.setRepeatingRequest(mPreviewBuilder.build(), mSessionCaptureCallback, mPreviewHandler);
        } else if (SpUtil.getCameraFormat(getActivity()).equals("DNG")) {
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            String cameraId = SpUtil.getCameraId(getActivity());
...
//            mRawImage = reader.acquireNextImage();
    ...
    private CameraCaptureSession.CaptureCallback mSessionCaptureCallback = new CameraCaptureSession.CaptureCallback() {
        ...
        public void onCaptureCompleted(CameraCaptureSession session, CaptureRequest request, TotalCaptureResult result) {
            mSession = session;
            if (!SpUtil.getCameraFormat(getActivity()).equals("DNG")) {
                checkState(result);
            }
